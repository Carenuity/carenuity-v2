        ...
        <div className="container relative">
          ...
          <div className="max-w-3xl pb-16 pt-4">
            ...
            <p className="text-lg leading-relaxed text-white/80 md:text-xl mb-8">
              Create 3D models and custom enclosures for your IoT device using
              TinkerCAD, then automate your smart home with Home Assistant.
              Design a professional housing for your sensor solution.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-body-color dark:text-gray-300 text-base leading-relaxed mb-6">
                Level 4 challenges you to design a professional enclosure for
                your IoT sensor device using TinkerCAD. Your design may be
                showcased on the Carenuity Solution Builder hero pages. You will
                also integrate your device with Home Assistant to automate smart
                home actions — combining physical design with software
                automation.
              </p>
                ...
                {[
                  {
                    ...
                    value: "TinkerCAD, Home Assistant",
                  },
        ...
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-body-color dark:text-gray-300 text-base leading-relaxed">
              Watch both tutorials to learn 3D enclosure design with TinkerCAD
              and smart home automation with Home Assistant.
            </p>
          </div>
      ...
      <section className="bg-white dark:bg-gray-950 py-16">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-body-color dark:text-gray-300 text-base leading-relaxed">
              Level 4 follows Bloom&apos;s Taxonomy — progressing from basic
              recall through to creating and evaluating a complete physical
              product.
            </p>
          </div>
      ...
      <section className="bg-white dark:bg-gray-950 py-16">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-body-color dark:text-gray-300 text-base leading-relaxed">
              Level 4 develops both technical design skills and the professional
              soft skills needed to bring an IoT product from concept to
              physical reality.
            </p>
          </div>
