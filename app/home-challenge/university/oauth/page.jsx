...
export default function OauthPage() {
  ...
  const p = t.homeChallengeUniversity.oauth;
  return (
    <main>
        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="flex-1 min-w-0">
              <iframe loading="lazy" className="w-full rounded-2xl shadow-sm mb-4" src="https://www.canva.com/design/DAGXGlpF8OE/FI_Vr5qggwhIXTRezelzsg/view?embed" style={{ height: "600px" }} />
              <p className="text-center text-sm text-gray-700 dark:text-gray-300 mb-6">
                <a href="https://www.canva.com/design/DAGXGlpF8OE/FI_Vr5qggwhIXTRezelzsg/view" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">{p.linkText}</a> {c.byCarenuity}
              </p>
              <div className="text-center">
                <Link href="/home-challenge/university/oauth/press" className="shadow-btn bg-primary hover:bg-primary-light rounded-full px-7 py-3 text-sm font-semibold text-white transition duration-300 inline-block">
                  {c.pressMaterials}
                </Link>
              </div>
            </div>
