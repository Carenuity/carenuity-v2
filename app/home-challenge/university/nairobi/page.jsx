...
export default function NairobiPage() {
  ...
  const p = t.homeChallengeUniversity.nairobi;
  return (
    <main>
        ...
        <div className="container relative">
          ...
          <div className="pb-12 pt-4 max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-6">
              ...
              <span className="text-xs font-semibold text-white tracking-wide uppercase">{p.locationBadge}</span>
            </div>
        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="flex-1 min-w-0">
              <iframe loading="lazy" className="w-full rounded-2xl shadow-sm mb-4" src="https://www.canva.com/design/DAGW1NlDwpw/EjOuorYweO_44m_LY-ZA_Q/view?embed" style={{ height: "600px" }} />
              <p className="text-center text-sm text-gray-700 dark:text-gray-300">
                <a href="https://www.canva.com/design/DAGW1NlDwpw/EjOuorYweO_44m_LY-ZA_Q/view" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">{p.linkText}</a> {c.byCarenuity}
              </p>
            </div>
          </div>
        </div>
