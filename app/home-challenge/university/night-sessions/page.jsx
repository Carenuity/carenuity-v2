...
export default function NightSessionsPage() {
  const { t } = useLanguage();
  const c = t.homeChallengeUniversity.common;
  const p = t.homeChallengeUniversity.nightSessions;
  return (
    <main>
        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="flex-1 min-w-0">
              <iframe loading="lazy" className="w-full rounded-2xl shadow-sm mb-4" src="https://www.canva.com/design/DAGg8rH7hKI/XEm8ljpKAjLyolO7QsdMgg/view?embed" style={{ height: "600px" }} />
              <p className="text-center text-sm text-gray-700 dark:text-gray-300">
                <a href="https://www.canva.com/design/DAGg8rH7hKI/XEm8ljpKAjLyolO7QsdMgg/view" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">{p.linkText}</a> {c.byCarenuity}
              </p>
            </div>
          </div>
        </div>
