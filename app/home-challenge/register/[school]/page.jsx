...
export async function generateMetadata({ params }) {
  ...
  if (!school) return {};
  return {
    title: `Registration for ${school.name} — Carenuity Home Challenge`,
    description: `Register as a ${school.name} student for the Carenuity Home Challenge and showcase your IoT skills.`,
  };
}

export default async function SchoolRegisterPage({ params }) {
  const { school: slug } = await params;
  const school = getSchoolBySlug(slug);
  if (!school) notFound();
      ...
      >
        ...
        <div className="container relative">
          <nav className="flex items-center gap-2 pt-6 pb-6 text-sm flex-wrap">
            ...
            <Link href="/home-challenge" className="text-green-300/70 hover:text-green-300 transition-colors">
              Home Challenge
            </Link>
            <span className="text-green-300/40">/</span>
          ...
          <div className="max-w-xl">
            ...
            <p className="text-white/80 text-lg leading-relaxed">
              ...
              student? Showcase your talent and grow your skills by subscribing
              to the {school.name} Home Challenge.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-12 gap-6">
            <div className="col-span-12 lg:col-span-8 lg:col-start-3 text-center">
              ...
              <p className="text-body-color dark:text-gray-300 text-base leading-relaxed mb-6">
                Carenuity provides modular and highly customizable sensor solutions
                for monitoring vital signs and real estate air quality. Our flagship
                product, the SQ-Panel, delivers 24/7 vital and environmental
                sensing &amp; care.
              </p>
