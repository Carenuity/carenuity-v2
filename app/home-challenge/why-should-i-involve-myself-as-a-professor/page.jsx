...
export const metadata = {
  title:
    "Why Should I Involve My Students as a Professor — Carenuity Home Challenge",
  description:
...
const reasons = [
  {
    ...
    desc: "Integrating the Home Challenge into your curriculum provides students with hands-on experience in building IoT devices. This practical approach enhances their learning and prepares them for real-world challenges.",
  },
  {
    title: "Industry Connections",
    desc: "Collaborating with the semiconductor industry like Bosch, Renesas, Infineon, NXP or TI by utilizing their sensors & microcontrollers, or with other industries like the hospitality sector in Greece with players like Grecotel Hotels & Resorts, Sani/Ikos Group, and Mitsis Hotels opens up opportunities for research partnerships, internships, and job placements for your students.",
  },
  {
    title: "Professional Development",
    desc: "Stay updated with the latest industry trends and technologies. Participating in the Home Challenge allows you to enhance your teaching and research capabilities, keeping you at the forefront of technological advancements.",
  },
  {
    title: "Innovation and Adaptability",
    desc: "Encourage your students to innovate and adapt to new technologies. The Home Challenge fosters a mindset of creativity and problem-solving — essential skills in the rapidly evolving field of IoT.",
  },
  {
    title: "Critical Evaluation of IoT Offerings",
    desc: "Equip your students with the ability to critically evaluate various IoT offerings. This skill helps them avoid vendor lock-in and ensures they choose the most cost-effective and suitable solutions for their needs.",
  },
];
...
const howItWorks = [
  {
    ...
    desc: "Collaborate with us to design the Home Challenge, jointly identify a suited sponsor (e.g. semiconductor, hospitality, or any other related industry), set sponsor-specific objectives, and promote the event.",
  },
  {
    title: "Execution",
    desc: "Students participate in the challenge, building AI-assisted IoT devices over six levels and solving real-world problems provided by the partner companies.",
  },
  {
        ...
        <div className="container relative">
          ...
          <div className="pb-12 pt-4 max-w-3xl">
            ...
            <h1 className="mb-4 text-3xl font-bold leading-tight text-white sm:text-4xl md:text-5xl">
              ...
              <br />
              <span className="text-green-300">Bridge Academia & Industry</span>
            </h1>
            <p className="text-lg leading-relaxed text-white/80 max-w-2xl">
              Integrate cutting-edge IoT and ML/AI technology into your
              curriculum and shape future industry leaders.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50 dark:bg-gray-900">
        <div className="container">
          ...
          <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
            ...
            engage with cutting-edge IoT and ML/AI technology and contribute to
            the development of future industry leaders. Here are some compelling
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 text-center">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-6 max-w-xl mx-auto">
              ...
              the future of IoT, ML/AI and the related industries? Contact us
