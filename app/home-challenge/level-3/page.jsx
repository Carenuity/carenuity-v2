        ...
        <div className="container relative">
          ...
          <div className="max-w-3xl pb-16 pt-4">
            ...
            <p className="text-lg leading-relaxed text-white/80 md:text-xl mb-8">
              Create your own app using ChatGPT-assisted coding in Arduino IDE
              with your own API keys — then upload your binary to the Carenuity
              Solution Builder and share your work with the community.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-body-color dark:text-gray-300 text-base leading-relaxed mb-6">
                In Level 3 you will use Arduino IDE — with optional ChatGPT
                assistance — to write code that integrates third-party APIs into
                your IoT device. Once complete, you will generate a merged
                binary and publish your solution to the Carenuity Solution
                Builder platform for the community to use.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  {
                    label: "Tools Required",
                    value: "Arduino IDE, ChatGPT, API keys, Solution Builder",
                  },
        ...
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-body-color dark:text-gray-300 text-base leading-relaxed">
              Watch both tutorials to understand Arduino coding with API
              integration and how to publish your project to the Solution
              Builder platform.
            </p>
          </div>
      ...
      <section className="bg-white dark:bg-gray-950 py-16">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-body-color dark:text-gray-300 text-base leading-relaxed">
              Complete all three steps to unlock your Level 3 reward — a DS18B20
              or Oximeter Sensor.
            </p>
          </div>
      ...
      <section className="bg-white dark:bg-gray-950 py-16">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-body-color dark:text-gray-300 text-base leading-relaxed">
              Level 3 takes you from hardware into software — combining coding,
              AI tools, and community publishing in one challenge.
            </p>
          </div>
      ...
      >
        <div className="container text-center">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">
            Write your Arduino code, integrate an API, publish to Solution
            Builder, and claim your sensor reward.
          </p>
