        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-3">{c.problemDesc}</p>
              ...
              {/* Solution */}
              <h3 className="text-xl font-bold text-[#0d2137] dark:text-white mb-3">{c.solutionTitle}</h3>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-4">{c.solutionDesc}</p>
              ...
              {/* Smart Alerts */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-2">{c.alertsTitle}</h2>
              <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">{c.alertsDesc}</p>
