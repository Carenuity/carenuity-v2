      ...
      >
        ...
        <div className="container relative">
          <nav className="flex items-center gap-2 pt-6 pb-4 text-sm">
            ...
            <span className="text-green-300/40">/</span>
            <span className="font-medium text-white">Magnetic Traffic Counting</span>
          </nav>
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="space-y-4 mb-10">
                <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{c.introP1}</p>
                <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{c.introP2}</p>
              </div>

              {/* Infineon Sensors */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-4">{c.infineonTitle}</h2>
              <div className="space-y-4 mb-10">
                <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{c.infineonP1}</p>
                <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{c.infineonP2}</p>
              </div>

              {/* Triple-Adapter Advantage */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-4">{c.tripleAdapterTitle}</h2>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-10">{c.tripleAdapterDesc}</p>

              {/* Build in Under 3 Minutes */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-4">{c.buildTitle}</h2>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-10">{c.buildDesc}</p>

              {/* How It Works */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-4">{c.howTitle}</h2>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-4">{c.howDesc}</p>
              ...
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-4">{c.startTitle}</h2>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-10">{c.startDesc}</p>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden mb-10">
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="flex-1 p-6 flex flex-col justify-center gap-4">
                    <h3 className="text-base font-bold text-[#0d2137] dark:text-white">{c.shopProduct}</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400 italic leading-relaxed">{c.shopDesc}</p>
