        ...
        <div className="container relative">
          <nav className="flex items-center gap-2 pt-6 pb-4 text-sm">
            ...
            <span className="font-medium text-white">
              {en ? "Payment Models" : "Bezahlmodelle"}
            </span>
          </nav>
          <div className="pb-12 pt-4 max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-6">
              ...
              <span className="text-xs font-semibold text-white tracking-wide uppercase">
                {en ? "Pricing & Payment" : "Preise & Zahlung"}
              </span>
            </div>
            ...
            <p className="text-lg leading-relaxed text-white/80 max-w-2xl">
              {en
                ...
                : "Wählen Sie das Bezahlmodell, das am besten zu Ihnen passt."}
            </p>
          </div>
        </div>
      </section>
              ...
              {sections.map((s) => (
                ...
                >
                  <h2 className="text-xl font-bold text-[#0d2137] dark:text-white mb-3">
                    {en ? s.en.heading : s.de.heading}
                  </h2>
                  <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                    {en ? s.en.body : s.de.body}
                  </p>
                </div>
              ))}
