        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="flex-1 min-w-0">
              ...
              {/* Intro paragraphs */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-6">Air Quality Index</h2>
              <div className="space-y-4 mb-10">
                ...
                <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{c.introP3}</p>
                <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{c.introP4}</p>
                <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{c.introP5}</p>
                <p className="text-sm font-semibold text-gray-800 dark:text-gray-100 leading-relaxed">{c.introP6}</p>
              </div>

              {/* Available Applications */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-6">{c.applicationsTitle}</h2>
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-10">
                {c.applications.map((app) => (
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-gray-800 dark:text-white">{app}</span>
                  </div>
                ))}
              </div>
