            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden mb-10">
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="flex-1 p-6 flex items-center">
                    <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{c.introDesc}</p>
                  </div>
                </div>
              </div>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-10">{c.lvglDesc}</p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-12">
                {c.features.map((feature, idx) => (
                  <div key={feature.title} className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
              ...
              {/* Documentation */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-4">{c.docsTitle}</h2>
              <div className="mb-12">
                <a
