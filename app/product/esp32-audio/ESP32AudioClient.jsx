        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="flex-1 min-w-0">
              ...
              {/* Architecture */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-6">{c.architectureTitle}</h2>
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden mb-10">
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="flex-1 p-6 flex items-center">
                    <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{c.introCardDesc}</p>
                  </div>
                </div>
              </div>

              {/* Requirements */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-4">{c.requirementsTitle}</h2>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-10">{c.requirementsDesc}</p>

              {/* Reference Design */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-4">{c.refDesignTitle}</h2>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-4">{c.refDesignDesc}</p>
              ...
              {/* Concept */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-4">{c.conceptTitle}</h2>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-3">{c.conceptDesc}</p>
              <a
              ...
              {/* Functional Modules */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-6">{c.modulesTitle}</h2>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
                {[c.sensorBlock, c.mcuBlock, c.actuatorBlock].map((block, idx) => (
                  <div key={block.title} className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
                    <div className="text-5xl font-black text-primary/10 dark:text-primary/20 mb-3 leading-none">
                      {["S", "M", "A"][idx]}
                    </div>
                    <h3 className="text-sm font-bold text-[#0d2137] dark:text-white mb-2">{block.title}</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">{block.desc}</p>
                  </div>
                ))}
              </div>

              {/* Storage Module */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-4">{c.storageTitle}</h2>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-3">{c.storageDesc}</p>
              <a
              ...
              {/* Advantages */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-6">{c.advantagesTitle}</h2>
              ...
              {/* Design Options */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-4">{c.designTitle}</h2>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-10">{c.designDesc}</p>

              {/* Get Started */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-4">{c.getStartedTitle}</h2>
              <div className="space-y-4 mb-12">
                <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{c.getStartedDesc}</p>
                <a
