export const sensors = [
  {
    ...
    de: {
      ...
      summary: "Das Piggyback AHT20-BMP280 vereint Temperatur-, Feuchtigkeits- und Drucksensoren auf einer einzigen Platine und liefert genaue Umgebungsmessungen bei minimalem Energie- und Platzbedarf.",
    },
  },
  {
    ...
    en: {
      ...
      summary: "The Piggyback AHT10 is a reliable and low-power temperature and humidity sensor module that outputs calibrated digital data via I²C.",
    },
    de: {
      explanation: "Das Piggyback AHT10 ist ein kompaktes digitales Temperatur- und Feuchtigkeitssensormodul auf Basis des AHT10-Chips von Aosong Electronics. Es misst Temperatur von -40°C bis +85°C mit ±0,3°C Genauigkeit und relative Luftfeuchtigkeit von 0% bis 100% RH mit ±2% Genauigkeit als kalibrierte Digitalwerte über I²C. Die Kalibrierungskoeffizienten sind on-chip gespeichert, sodass keine externe Kalibrierung erforderlich ist. Mit 1,8V–3,6V ist es vollständig mit 3,3V-MCUs kompatibel und steckt direkt auf den C3-Mini-Header auf. Schnelle Messzyklen und niedriger Standbystrom machen es ideal für Sensorknoten mit periodischem Aufwachen und Tiefschlaf.",
      features: [
      ...
      summary: "Das Piggyback AHT10 ist ein zuverlässiges und energiesparendes Temperatur- und Feuchtigkeitssensormodul, das kalibrierte Digitaldaten über I²C ausgibt.",
    },
  },
  {
    ...
    en: {
      ...
      summary: "The Piggyback AHT20 is the improved successor of the AHT10, delivering higher accuracy, wider voltage compatibility, and greater stability for temperature and humidity sensing.",
    },
    de: {
      explanation: "Das Piggyback AHT20 ist das Upgrade der zweiten Generation zum AHT10, entwickelt von Aosong Electronics, um Langzeitdrift und Spannungskompatibilitätsprobleme zu beheben. Es misst Temperatur von -40°C bis +85°C mit ±0,3°C Genauigkeit und relative Luftfeuchtigkeit von 0% bis 100% RH mit ±2% Genauigkeit als werkskalibrierte Digitalwerte über I²C. Der breitere Versorgungsbereich von 2,0V–5,5V gewährleistet Kompatibilität mit mehr Mikrocontrollern ohne Pegelwandler. Verbesserte Filteralgorithmen bieten bessere Stabilität gegen Langzeitdrift. Das AHT20 steckt direkt auf den C3-Mini-Header auf und eignet sich ideal für batteriebetriebene IoT-Knoten.",
      features: [
      ...
      summary: "Das Piggyback AHT20 ist der verbesserte Nachfolger des AHT10 und bietet höhere Genauigkeit, breiteren Spannungsbereich und größere Stabilität für die Temperatur- und Feuchtigkeitsmessung.",
    },
  },
  {
    ...
    shopLink: null,
    en: {
      explanation: "The Piggyback AGS10 is a compact gas sensor module for indoor air quality monitoring, using a metal-oxide element to detect a broad range of volatile organic compounds (VOCs) including alcohols, aldehydes, and ketones. Rather than raw resistance values, the AGS10 outputs a pre-calculated TVOC index and equivalent CO₂ (eCO₂) value directly over I²C, simplifying firmware integration. Built-in baseline compensation automatically adjusts for sensor aging and temperature fluctuations. The module runs on 3.3V or 5V with low active current, and clips onto the C3-Mini without any extra wiring or PCB area.",
      features: [
      ...
      summary: "The Piggyback AGS10 gas sensor module provides a simple and reliable way to measure VOC-based air quality. With digital I²C output, low power use, and a plug-and-play piggyback design, it is ideal for IoT developers, smart home applications, and portable air quality monitors.",
    },
    de: {
      explanation: "Das Piggyback AGS10 ist ein kompaktes Gassensormodul für die Innenraumluftqualitätsüberwachung, das ein Metalloxid-Sensorelement zur Erkennung flüchtiger organischer Verbindungen (VOCs) verwendet. Anstatt rohe Widerstandswerte auszugeben, liefert der AGS10 einen vorberechneten TVOC-Index und eCO₂-Äquivalentwert direkt über I²C. Die integrierte Basiskompensation passt sich automatisch an Sensoralterung und Temperaturschwankungen an. Das Modul läuft mit 3,3V oder 5V, hat niedrigen Aktivstrom und steckt ohne zusätzliche Verkabelung direkt auf den C3-Mini auf.",
      features: [
      ...
      summary: "Das Piggyback AGS10 Gassensormodul bietet eine einfache und zuverlässige Möglichkeit zur VOC-basierten Luftqualitätsmessung. Mit I²C-Digitalausgang, niedrigem Energieverbrauch und Plug-and-Play-Piggyback-Design ist es ideal für IoT-Entwickler, Smart-Home-Anwendungen und tragbare Luftqualitätsmonitore.",
    },
  },
  {
    ...
    de: {
      ...
      summary: "Das Piggyback BME280 bietet eine vollständige Klimamesslösung mit Temperatur-, Feuchtigkeits- und Druckmessungen in einem Modul. Das Piggyback-Design ermöglicht die einfache Integration in kompakte IoT- und Embedded-Projekte und ist ideal für Wetterverfolgung, Smart-Home-Systeme und mobile Anwendungen.",
    },
  },
  {
    ...
    de: {
      ...
      summary: "Das Piggyback BMP280 ist ein zuverlässiges und effizientes Druck- und Temperatursensormodul für IoT und Embedded-Anwendungen. Im Gegensatz zum BME280 fehlt die Feuchtigkeitsmessung, was es zur kosteneffizienten Option macht, wenn nur Temperatur- und Druckdaten benötigt werden.",
    },
  },
  {
    ...
    de: {
      ...
      summary: "Das Piggyback BMP180 ist ein bewährtes Druck- und Temperatursensormodul mit zuverlässiger Leistung in einem einfachen, kostengünstigen Design. Während neuere BMP280/BME280-Sensoren höhere Präzision bieten, bleibt das BMP180 eine solide Wahl für budgetfreundliche Umweltüberwachungsprojekte.",
    },
  },
  {
    ...
    de: {
      ...
      summary: "Das Piggyback SHT40 ist ein Temperatur- und Feuchtigkeitssensormodul der nächsten Generation mit höherer Präzision, Ultra-Low-Power-Betrieb und Langzeitstabilität. Ideal für IoT-Entwickler, Umweltüberwachung und Präzisionsklimasteuerung.",
    },
  },
  {
    ...
    shopLink: null,
    en: {
      explanation: "The Piggyback SGP30 is Sensirion's indoor air quality sensor module, using a metal-oxide (MOX) element to detect total volatile organic compounds (TVOCs) and output an equivalent CO₂ (eCO₂) level. An on-chip signal conditioning algorithm converts raw MOX readings into TVOC (ppb) and eCO₂ (ppm) values, greatly simplifying host firmware. A humidity compensation input lets you feed temperature and humidity data from a paired sensor for improved accuracy, and a built-in baseline calibration cycle adapts to long-term background VOC changes. With an I²C interface, 1.8V–3.6V supply, and low power consumption, the SGP30 stacks directly onto the C3-Mini for complete air quality monitoring with no extra hardware.",
      features: [
    ...
    de: {
      ...
      summary: "Das Piggyback SGP30 ist ein zuverlässiges Luftqualitätssensormodul für VOC- und CO₂-Äquivalentmessungen im kompakten, energiesparenden Format. Ideal für Smart-Home-Geräte, HVAC-Optimierung und tragbare Luftqualitätsmonitore.",
    },
  },
  {
    ...
    de: {
      ...
      summary: "Das Piggyback SGP40 ist ein verbessertes VOC-Sensormodul mit höherer Zuverlässigkeit und Stabilität als das SGP30. Der VOC-Index vereinfacht die Innenraumluftqualitätsüberwachung und eignet sich hervorragend für IoT-Geräte und Smart-Home-Anwendungen.",
    },
  },
  {
    ...
    de: {
      ...
      summary: "Das Piggyback ENS160 ist ein Multigas-Sensormodul der nächsten Generation mit vollständiger digitaler Luftqualitätslösung (VOC, eCO₂, AQI). Ideal für IoT-Entwickler, HVAC-Optimierung und Smart-Home- oder Gebäudeanwendungen.",
    },
  },
  {
    ...
    de: {
      ...
      summary: "Das Piggyback CCS811 ist ein digitales Innenraum-Luftqualitätssensormodul für VOC- und CO₂-Äquivalentmessungen mit geringem Energieverbrauch und einfacher I²C-Integration. Eine bewährte, kostengünstige Option für IoT- und Smart-Building-Anwendungen.",
    },
  },
  {
    ...
    de: {
      ...
      summary: "Das Piggyback MICS-6814 ist ein leistungsstarkes Multigas-Sensormodul mit breiter Erkennungsfähigkeit für toxische Gase, Schadstoffe und brennbare Gase. Trotz erforderlicher analoger Signalverarbeitung ist es eine starke Wahl für Umweltsensing, Industriesicherheit und IoT-Luftqualitätsmonitoring.",
    },
  },
  {
    ...
    shopLink: null,
    en: {
      explanation: "The Piggyback LD2410 is a 24 GHz FMCW radar sensor module for human presence and motion detection, capable of detecting the tiny chest-wall movements caused by breathing — something PIR sensors fundamentally cannot achieve. It reliably reports that a stationary person is present even when sitting quietly, sleeping, or concentrating at a desk. The module supports UART for full configuration and data output, plus a GPIO pin for simple binary presence/absence triggers. With detection range up to 6 metres for presence and ~5 metres for micro-motion, a ~100° × 40° field of view, and 3.3V–5V supply, it stacks directly onto the C3-Mini with no extra wiring.",
      features: [
    ...
    de: {
      ...
      summary: "Das Piggyback LD2410 ist ein radarbasiertes Präsenz- und Bewegungserkennungsmodul, das herkömmliche PIR-Sensoren übertrifft, indem es sowohl Bewegung als auch stationäre Präsenz erkennt. Ideal für Smart Homes, IoT-Systeme und Sicherheitsanwendungen.",
    },
  },
  {
    ...
    de: {
      ...
      summary: "Das Piggyback LD6002 ist ein Radarbewegungssensormodul der nächsten Generation mit größerer Reichweite, feinerer Erkennung und besserer Stabilität als Einstiegsradarsensoren wie das LD2410. Ideal für Smart Homes, Sicherheit, Gesundheitsversorgung und IoT-Anwendungen.",
    },
  },
  {
    ...
    en: {
      ...
      summary: "The Piggyback TSL2591 is a high-performance ambient light sensor module, offering ultra-wide dynamic range, high accuracy, and infrared compensation. Its piggyback format makes it compact and easy to integrate, making it ideal for IoT, smart home, portable devices, and automated lighting applications.",
    },
    de: {
      explanation: "Das Piggyback TSL2591 ist ams OSRAMs Premium-Umgebungslichtsensor mit einem außergewöhnlichen Dynamikbereich von 188 µlux bis 88.000 lux, der einem Sensor ermöglicht, alles von einer mondbeleuchteten Nacht bis zu direktem Sonnenlicht zu messen. Eine Zweifotodioden-Architektur — eine für Infrarot und sichtbares Licht, eine nur für Infrarot — ermöglicht Infrarotkompensation für genaue Lux-Werte, die dem menschlichen Sehen entsprechen. Die 16-Bit-ADC-Auflösung mit programmierbarer Verstärkung und konfigurierbaren Integrationszeiten gibt präzise Kontrolle über die Empfindlichkeit. Eine I²C-Schnittstelle mit programmierbaren Interrupt-Schwellenwerten eliminiert ständige Abfragen, und das TSL2591-Piggyback steckt mit 2,7V–3,6V auf den C3-Mini auf.",
      features: [
      ...
      summary: "Das Piggyback TSL2591 ist ein leistungsstarkes Umgebungslichtsensormodul mit ultra-breitem Dynamikbereich, hoher Genauigkeit und Infrarotkompensation. Ideal für IoT, Smart Home, tragbare Geräte und automatisierte Beleuchtungsanwendungen.",
    },
  },
  {
    ...
    en: {
      ...
      summary: "The Piggyback MAX30102 is a compact, low-power pulse oximeter and heart-rate sensor module that provides accurate biometric measurements. Its piggyback design makes it integration-friendly for wearables, smart health devices, and IoT medical monitoring solutions.",
    },
    de: {
      explanation: "Das Piggyback MAX30102 ist Maxim Integrateds Pulsoximeter- und Herzfrequenzsensor, der rote und Infrarot-LEDs, einen hochempfindlichen Fotodetektor und ein rauscharmes Analog-Frontend in einem einzigen kompakten Gehäuse kombiniert. Es verwendet Photoplethysmografie (PPG), um den pulsatilen Blutfluss zu erkennen und die Herzfrequenz abzuleiten, und schätzt durch Wechsel zwischen roter und IR-Beleuchtung auch SpO₂. Eine On-Chip-Umgebungslichtkompensationsschaltung unterdrückt Raumlichtstörungen. Konfigurierbare LED-Strom, Abtastrate (bis zu 3200 Hz) und ADC-Auflösung geben volle Kontrolle, und der MAX30102 schnappt für einen kompakten Gesundheitsmonitor auf den C3-Mini auf.",
      features: [
      ...
      summary: "Das Piggyback MAX30102 ist ein kompaktes, energiesparendes Pulsoximeter- und Herzfrequenzsensormodul für genaue biometrische Messungen. Ideal für Wearables, Smart-Health-Geräte und IoT-Medizinmonitoring.",
    },
  },
  {
    ...
    de: {
      ...
      summary: "Das Piggyback TCS3472 ist ein kompaktes digitales Farbsensormodul für RGB-Werte, Umgebungslicht und Farbtemperatur. Einfach zu verwenden in IoT-Geräten, Robotik, Smart Lighting und Display-Kalibrierungssystemen.",
    },
  },
  {
    name: "Piggyback CH20",
    ...
    de: {
      ...
      summary: "Das Piggyback CH20 ist ein Formaldehydgassensormodul für die genaue Erkennung von HCHO in Innenräumen und industriellen Umgebungen. Ideal für Luftqualitätsmonitore, Smart-Home-Geräte und IoT-Gesundheits- und Sicherheitslösungen.",
    },
  },
];
