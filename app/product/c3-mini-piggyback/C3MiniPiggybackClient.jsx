...
const labels = {
  en: { features: "Key Features", applications: "Applications", summary: "Summary" },
  de: { features: "Wichtigste Merkmale", applications: "Anwendungen", summary: "Zusammenfassung" },
};
                    ...
                    <div key={sensor.name}>
                      ...
                      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden mb-5">
                        <div className="flex flex-col sm:flex-row">
                          <div className="relative sm:w-52 shrink-0 bg-gray-50 dark:bg-gray-900" style={{ minHeight: "200px" }}>
                            <Image
                              src={sensor.image}
                              alt={sensor.name}
                              fill
                      ...
                      {i === 0 && (
                        <>
                          ...
                          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                            <div className="flex flex-col sm:flex-row">
                              <div className="relative sm:w-48 shrink-0 bg-gray-50 dark:bg-gray-900" style={{ minHeight: "160px" }}>
                                <Image
                              ...
                              <div className="flex-1 p-6">
                                ...
                                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4 leading-relaxed">
                                  The C3-Mini Sensor Piggyback combines two high-precision sensors: the AHT20 for temperature and humidity, and the BMP280 for air pressure and temperature. Ideal for IoT applications.
                                </p>
