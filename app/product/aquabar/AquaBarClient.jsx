        ...
        <div className="container relative">
          ...
          <div className="grid grid-cols-12 min-h-[380px] items-center pb-12 pt-4">
            <div className="col-span-12 md:col-span-7">
              ...
              <p className="mb-3 text-base text-white/80 italic">{c.heroTagline}</p>
              <p className="mb-8 text-lg leading-relaxed text-white/70 max-w-xl">{c.heroDesc}</p>
              <button
                ...
                style={{ backgroundColor: "rgba(255,255,255,0.15)", border: "2px solid rgba(134,239,172,0.5)" }}
              >
                {c.wishlistBtn}
        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="flex-1 min-w-0 space-y-14">
              ...
              {/* The Problem */}
              <div>
                <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-5">{c.problemTitle}</h2>
              ...
              {/* The Solution */}
              <div>
                <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-4">{c.solutionTitle}</h2>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">{c.solutionDesc}</p>
                ...
                <div className="flex items-start gap-3 p-4 rounded-xl bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
                  <svg className="w-5 h-5 text-green-700 dark:text-green-400 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                  </svg>
                  <p className="text-sm text-green-800 dark:text-green-300">{c.alertDesc}</p>
                </div>
              </div>

              {/* Key Benefits */}
              <div>
                <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-5">{c.benefitsTitle}</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {c.benefits.map((b) => (
                    ...
                    >
                      ...
                      <h3 className="font-bold text-[#0d2137] dark:text-white mb-1 text-sm">{b.title}</h3>
              ...
              {/* How It Works */}
              <div>
                <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-5">{c.howTitle}</h2>
              ...
              {/* Who Is It For */}
              <div>
                <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-5">{c.audienceTitle}</h2>
                <ul className="space-y-3">
              ...
              {/* Product Options */}
              <div>
                <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-5">{c.optionsTitle}</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  {[
                    ...
                    >
                      <h3 className="font-bold text-[#0d2137] dark:text-white mb-4">{title}</h3>
