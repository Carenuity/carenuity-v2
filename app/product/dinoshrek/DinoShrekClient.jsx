            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
                {c.howSteps.map((step, idx) => (
                  <div key={step.title} className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
                    ...
                    <h3 className="text-sm font-bold text-[#0d2137] dark:text-white mb-2">{step.title}</h3>
              ...
              {/* Modular Design */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-4">{c.modularTitle}</h2>
              <div className="space-y-4 mb-12">
                <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{c.modularP1}</p>
                <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{c.modularP2}</p>
              </div>

              {/* Included in the Box */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-6">{c.boxTitle}</h2>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {c.boxItems.map((item, idx) => (
                      <tr key={item.component} className={idx % 2 === 0 ? "bg-gray-50 dark:bg-gray-700/40" : ""}>
                        <td className="px-5 py-3 font-semibold text-[#0d2137] dark:text-white w-2/5">{item.component}</td>
                        <td className="px-5 py-3 text-gray-600 dark:text-gray-300">{item.desc}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              {/* Use Cases */}
              <h2 className="text-2xl font-bold text-[#0d2137] dark:text-white mb-6">{c.useCasesTitle}</h2>
              ...
              {/* Why DinoShrek */}
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 mb-12">
                <h2 className="text-xl font-bold text-[#0d2137] dark:text-white mb-3">{c.whyTitle}</h2>
                <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-4">{c.whyDesc}</p>
                <p className="text-sm font-bold text-[#0d2137] dark:text-white mb-1">{c.ctaTitle}</p>
                <p className="text-sm text-gray-500 dark:text-gray-400 italic">{c.ctaDesc}</p>
              </div>
