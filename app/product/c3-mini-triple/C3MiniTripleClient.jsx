              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden mb-10">
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="flex-1 p-6 flex flex-col justify-center gap-4">
                    <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{c.whatP1}</p>
                    <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{c.whatP2}</p>
