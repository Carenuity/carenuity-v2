          ...
          <div className="grid grid-cols-12 min-h-[360px] items-center">
            <div className="col-span-12 md:col-span-8 pb-16 pt-4">
              ...
              <p className="text-lg leading-relaxed text-white/80 md:text-xl">
                Seven featured sensors in one convenient box — everything you
                need to start building environmental and interactive IoT
                projects.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="text-body-color dark:text-green mb-4 text-base leading-relaxed">
                The C3-Mini™ Sensor Selection Box is a modular starter kit
                designed for students, makers, and developers who want to
                explore a range of IoT sensor types without sourcing components
                individually.
              </p>
              <p className="text-body-color dark:text-green mb-6 text-base leading-relaxed">
                Each box includes seven sensors compatible with the C3-Mini™
                board, along with example code and documentation to get you
                started fast. Swap sensors in and out to build exactly the
      ...
      <section className="bg-green-bg dark:bg-gray-900 py-16">
        <div className="container">
          ...
          <p className="text-body-color dark:text-green mb-10 text-base">
            The selection box includes one of each sensor below — a complete
            toolkit for environmental sensing and interaction projects.
          </p>
