  ...
  return (
    <main>
        ...
        <div className="container">
          <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="text-body-color dark:text-green mb-4 text-base leading-relaxed">{c.whatP1}</p>
              <p className="text-body-color dark:text-green mb-6 text-base leading-relaxed">{c.whatP2}</p>
              <Link
            ...
            <div className="relative h-[320px] w-full">
              <Image src="/images/selection-boxes/budget-products.webp" alt="C3-Mini™ Budget Products" fill className="object-contain" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-green-bg dark:bg-gray-900 py-16">
        <div className="container">
          <h2 className="mb-4 text-3xl font-bold text-black dark:text-white md:text-4xl">{c.sensorsTitle}</h2>
          <p className="text-body-color dark:text-green mb-10 text-base">{c.sensorsDesc}</p>
