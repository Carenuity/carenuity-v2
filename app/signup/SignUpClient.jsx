...
const GoogleIcon = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
    <g clipPath="url(#g2)">
      ...
      />
      <path
        d="M4.39911 11.9777C4.17592 11.3411 4.06075 10.673 4.05819 9.99996C4.0623 9.32799 4.17322 8.66075 4.38696 8.02225L1.08852 5.51101C0.372885 6.90343 0 8.4408 0 9.99987C0 11.5589 0.372885 13.0963 1.08852 14.4887L4.39911 11.9777Z"
        fill="#FBBC05"
      />
      <path
    ...
    <main className="relative z-10 overflow-hidden pt-36 pb-16 lg:pt-44 lg:pb-28 bg-white dark:bg-gray-dark min-h-screen flex items-center">
      <div className="absolute inset-0 z-[-1] overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 80% 30%, #174f2e 0%, transparent 60%)",
          }}
        />
      </div>
        ...
        <div className="max-w-[520px] mx-auto">
          <div className="shadow-three dark:shadow-none rounded-2xl bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-800 px-8 py-10 sm:px-12 sm:py-12">
            ...
            <div className="flex items-center gap-4 mb-7">
              ...
              <span className="text-sm text-body-color dark:text-green whitespace-nowrap">
                {s.or}
              </span>
              <div className="flex-1 h-px bg-gray-200 dark:bg-gray-700" />
            </div>
            ...
            <form className="space-y-5">
              ...
              <div>
                <label className="flex items-start gap-3 cursor-pointer text-sm text-body-color dark:text-green">
                  <input
                    type="checkbox"
