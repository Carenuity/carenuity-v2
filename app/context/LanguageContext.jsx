...
export const translations = {
  en: {
    ...
    about: {
      pageName: "About Us",
      pageDesc: "Carenuity provides modular and highly customizable sensor solutions for monitoring vital signs and real estate air quality.",
      badge: "Who We Are",
      heroHeadline: "Learn More About Us",
      heroSubline: "Discover our mission, our technology, and the innovation driving smarter, safer, and more connected care solutions.",
      introTitle: "About Us",
      heroTitle: "Carenuity provides modular and highly customizable sensor solutions designed to monitor vital signs and real estate air quality with precision and reliability. By combining advanced sensing technology with flexible system design, these solutions adapt seamlessly to different environments—whether in residential spaces, healthcare settings, or smart buildings. The focus is on delivering real-time insights that support healthier living, improved safety, and smarter decision-making.",
      heroDesc: "A premium and widely adopted solution is the SQ-Panel, built to deliver continuous peace of mind through 24/7 monitoring of both vital and environmental conditions. With its intelligent sensing capabilities and integrated care features, the SQ-Panel ensures that critical data is always available when it matters most, enabling a safer, more responsive, and connected living environment.",
      missionTitle: "Our Mission",
      missionDesc: "Our Mission is to provide all young and caregiving people with especially easy-to-use sensor-systems that allow them to monitor vital signs and indoor air quality parameters for their elderly family members.",
      visionTitle: "Our Vision",
      visionDesc: "Empower young and caregiving people with innovative and accessible technology solutions that enhance the safety, comfort, and well-being of elderly individuals, enabling them to age in place with dignity, privacy and independence.",
      overviewTitle: "What We Do",
      overviewDesc: "Carenuity is a smart home health-tech solution by ChipGlobe GmbH. Our core product, the SQ-Panel, captures CO₂, TVOC, temperature, humidity, air pressure, and presence detection. The system supports Matter compatibility with Alexa, Google Home, and Apple HomeKit integration.",
      overviewList: [
      ...
      educationDesc: "Carenuity supports student development through the Home Challenge initiative, teaching IoT sensor setup, data analysis, and custom solution building.",
      brandTitle: "Brand Presence",
      brandDesc: "Find us across the maker and developer ecosystem:",
      brands: [
        { name: "Hackster.io", desc: "Project integrations and maker community" },
        ...
        { name: "Instagram", desc: "@carenuity · @diy_carenuity · @bts_carenuity" },
        { name: "LinkedIn", desc: "Company updates and professional network" },
      ],
      instagramTitle: "Our Instagram Channels",
      instagramChannels: [
        { handle: "@carenuity", label: "Premium Channel", target: "Professionals, caregivers, decision-makers", purpose: "Showcase SQ-Panel and reinforce premium positioning." },
        { handle: "@diy_carenuity", label: "Maker Channel", target: "Makers, students, DIY users", purpose: "Foster innovation and build the maker community." },
        { handle: "@bts_carenuity", label: "Insights Channel", target: "Non-technical users, caregivers", purpose: "Collect insights and improve storytelling." },
      ],
      contactTitle: "Get In Touch",
      contactAddress: "Chipglobe GmbH, Cincinnatistr. 60, 81549 Munich, Germany",
      contactEmail: "info@carenuity.com",
      contactPhone: "(+49) 89-1222469-40",
      legalNote: "Carenuity™ is a registered EU wordmark (EUIPO #018596314) owned by Chipglobe GmbH.",
      brandVisibilityTitle: "Brand Visibility",
      brandVisibilityDesc: "Carenuity maintains a strong presence across the developer and maker ecosystem, ensuring maximum reach and community engagement.",
      sqPanelTitle: "Featured Product: Carenuity™ SQ-Panel",
      sqPanelDesc1: "The SQ-Panel is a stylish, wall-mounted sensor display that captures CO₂, TVOC, temperature, humidity, air pressure, and presence detection — all in one compact device.",
      sqPanelDesc2: "It supports Matter compatibility and integrates seamlessly with Alexa, Google Home, and Apple HomeKit. Managed via the Carenuity Home App on iOS and Android with real-time monitoring and push notifications.",
      sqPanelFeatures: ["CO₂ & TVOC Sensing", "Temperature & Humidity", "Air Pressure", "Presence Detection", "Matter Compatible", "iOS & Android App"],
      solutionBuilderTitle: "Carenuity™ Solution Builder",
      solutionBuilderDesc: "The web-based Solution Builder allows users to configure, customize, and deploy sensor solutions without writing a single line of code. Select sensors, assign ecosystems, and generate ready-to-flash firmware instantly from your browser.",
      solutionBuilderFeatures: ["No code required", "Browser-based tool", "Supports all C3-Mini sensors", "Multi-ecosystem output", "Instant firmware generation"],
      ipTitle: "Intellectual Property Note",
      ipDesc: "Carenuity™ is a registered EU wordmark (EUIPO #018596314) owned by Chipglobe GmbH. All product names, logos, and designs are protected intellectual property of Chipglobe GmbH. Unauthorized use is prohibited.",
      strategicTitle: "Strategic Benefits",
      strategicItems: [
        { title: "Modular & Scalable", desc: "Easily customize and expand your sensor network to fit any environment — from a single room to an entire building." },
        { title: "Privacy-First Architecture", desc: "Data stays local by default. We never sell your data, and our system is designed with privacy-friendly principles from the ground up." },
        { title: "Award-Winning Innovation", desc: "Recognized with the BSFZ Seal 2025 for Research & Development by the Federal Republic of Germany — certified innovation." },
        { title: "Smart Home Compatible", desc: "Full Matter support enables seamless integration with Alexa, Google Home, and Apple HomeKit out of the box." },
        { title: "Budget-Friendly Options", desc: "C3-Mini kits give makers, students, and DIY enthusiasts access to professional-grade sensing at an accessible price point." },
        { title: "Educational Impact", desc: "The Home Challenge initiative empowers students to learn IoT, data analysis, and solution building hands-on." },
      ],
    },
    benefits: {
      badge: "Why Carenuity",
      heroTitle: "Benefits",
      heroDesc: "Discover how Carenuity's modular sensor solutions bring measurable value to homes, healthcare settings, and smart buildings.",
      videoTitle: "See Carenuity in Action",
      videoDesc: "Watch how Carenuity sensor solutions work in real environments — from setup to live monitoring.",
      ...
      useCases: [
        { title: "Residential Homes", desc: "Monitor air quality, temperature, and presence to keep families safe and comfortable." },
        { title: "Healthcare Settings", desc: "Track vital environmental parameters in care facilities to support patient well-being and staff efficiency." },
        { title: "Smart Buildings", desc: "Deploy scalable sensor networks across offices, classrooms, and real estate to optimize indoor environments." },
        { title: "Educational Programs", desc: "Empower students through the Home Challenge initiative to build and deploy their own sensor solutions." },
      ],
      ctaTitle: "Ready to get started?",
      ctaDesc: "Install your first sensor solution for free and start monitoring what matters most.",
  ...
  de: {
    ...
    about: {
      pageName: "Über uns",
      pageDesc: "Carenuity bietet modulare und hochgradig anpassbare Sensorlösungen zur Überwachung von Vitalzeichen und Raumluftqualität.",
      badge: "Wer wir sind",
      heroHeadline: "Mehr über uns erfahren",
      heroSubline: "Entdecken Sie unsere Mission, unsere Technologie und die Innovation, die intelligentere, sicherere und vernetztere Pflegelösungen antreibt.",
      introTitle: "Über uns",
      heroTitle: "Carenuity bietet modulare und hochgradig anpassbare Sensorlösungen, die präzise und zuverlässig Vitalzeichen und Raumluftqualität überwachen. Durch die Kombination fortschrittlicher Sensortechnologie mit flexiblem Systemdesign passen sich diese Lösungen nahtlos an verschiedene Umgebungen an – ob in Wohnräumen, Gesundheitseinrichtungen oder Smart Buildings. Der Fokus liegt auf der Bereitstellung von Echtzeit-Erkenntnissen, die ein gesünderes Leben, mehr Sicherheit und klügere Entscheidungen unterstützen.",
      heroDesc: "Eine premium und weit verbreitete Lösung ist das SQ-Panel, das kontinuierlichen Seelenfrieden durch 24/7-Überwachung von vitalen und Umgebungsbedingungen bietet. Mit seinen intelligenten Sensorfähigkeiten und integrierten Pflegefunktionen stellt das SQ-Panel sicher, dass kritische Daten immer verfügbar sind, wenn es darauf ankommt.",
      missionTitle: "Unsere Mission",
      missionDesc: "Unsere Mission ist es, allen jungen Menschen und Pflegenden besonders einfach zu bedienende Sensorsysteme bereitzustellen, mit denen sie Vitalzeichen und Innenraumluftqualität für ihre älteren Familienmitglieder überwachen können.",
      visionTitle: "Unsere Vision",
      visionDesc: "Wir möchten junge Menschen und Pflegende mit innovativen und zugänglichen Technologielösungen stärken, die Sicherheit, Komfort und Wohlbefinden älterer Menschen verbessern und ihnen ein würdevolles, selbstbestimmtes Leben ermöglichen.",
      overviewTitle: "Was wir tun",
      overviewDesc: "Carenuity ist eine Smart-Home-Gesundheitstechnologielösung von ChipGlobe GmbH. Unser Kernprodukt, das SQ-Panel, erfasst CO₂, TVOC, Temperatur, Luftfeuchtigkeit, Luftdruck und Anwesenheit. Das System unterstützt Matter-Kompatibilität mit Alexa, Google Home und Apple HomeKit.",
      overviewList: [
        "SQ-Panel Sensor-Display",
        "SQ-Connector Matter",
        "SQ-Stromversorgung",
      ...
      educationDesc: "Carenuity unterstützt die Entwicklung von Studierenden durch die Home Challenge Initiative, die IoT-Sensor-Einrichtung, Datenanalyse und benutzerdefinierte Lösungserstellung lehrt.",
      brandTitle: "Markenpräsenz",
      brandDesc: "Finden Sie uns im gesamten Maker- und Entwickler-Ökosystem:",
      brands: [
        { name: "Hackster.io", desc: "Projektintegrationen und Maker-Community" },
        { name: "GitHub", desc: "Firmware und API-Code" },
        { name: "YouTube", desc: "Unboxing-, Einrichtungs- und Tutorial-Videos" },
        { name: "Thingiverse", desc: "3D-druckbare Montagedesigns" },
        { name: "Instagram", desc: "@carenuity · @diy_carenuity · @bts_carenuity" },
        { name: "LinkedIn", desc: "Unternehmensupdates und professionelles Netzwerk" },
      ],
      instagramTitle: "Unsere Instagram-Kanäle",
      instagramChannels: [
        { handle: "@carenuity", label: "Premium-Kanal", target: "Fachleute, Pflegende, Entscheidungsträger", purpose: "SQ-Panel präsentieren und Premium-Positionierung stärken." },
        { handle: "@diy_carenuity", label: "Maker-Kanal", target: "Maker, Studierende, DIY-Nutzer", purpose: "Innovation fördern und die Maker-Community aufbauen." },
        { handle: "@bts_carenuity", label: "Insights-Kanal", target: "Nicht-technische Nutzer, Pflegende", purpose: "Einblicke sammeln und Storytelling verbessern." },
      ],
      contactTitle: "Kontakt aufnehmen",
      contactAddress: "Chipglobe GmbH, Cincinnatistr. 60, 81549 München, Deutschland",
      contactEmail: "info@carenuity.com",
      contactPhone: "(+49) 89-1222469-40",
      legalNote: "Carenuity™ ist eine eingetragene EU-Wortmarke (EUIPO #018596314) im Besitz von Chipglobe GmbH.",
      brandVisibilityTitle: "Markensichtbarkeit",
      brandVisibilityDesc: "Carenuity ist im Entwickler- und Maker-Ökosystem stark vertreten und sorgt für maximale Reichweite und Community-Engagement.",
      sqPanelTitle: "Hauptprodukt: Carenuity™ SQ-Panel",
      sqPanelDesc1: "Das SQ-Panel ist ein elegantes, wandmontiertes Sensordisplay, das CO₂, TVOC, Temperatur, Luftfeuchtigkeit, Luftdruck und Anwesenheit erfasst — alles in einem kompakten Gerät.",
      sqPanelDesc2: "Es unterstützt Matter-Kompatibilität und lässt sich nahtlos mit Alexa, Google Home und Apple HomeKit integrieren. Verwaltung über die Carenuity Home App auf iOS und Android mit Echtzeit-Überwachung und Push-Benachrichtigungen.",
      sqPanelFeatures: ["CO₂ & TVOC-Messung", "Temperatur & Luftfeuchtigkeit", "Luftdruck", "Anwesenheitserkennung", "Matter-kompatibel", "iOS & Android App"],
      solutionBuilderTitle: "Carenuity™ Solution Builder",
      solutionBuilderDesc: "Der webbasierte Solution Builder ermöglicht es Nutzern, Sensorlösungen ohne eine einzige Zeile Code zu konfigurieren und bereitzustellen. Sensoren auswählen, Ökosysteme zuweisen und sofort fertige Firmware im Browser generieren.",
      solutionBuilderFeatures: ["Kein Code erforderlich", "Browserbasiertes Tool", "Unterstützt alle C3-Mini-Sensoren", "Multi-Ökosystem-Ausgabe", "Sofortige Firmware-Generierung"],
      ipTitle: "Hinweis zum geistigen Eigentum",
      ipDesc: "Carenuity™ ist eine eingetragene EU-Wortmarke (EUIPO #018596314) im Besitz von Chipglobe GmbH. Alle Produktnamen, Logos und Designs sind geschütztes geistiges Eigentum der Chipglobe GmbH. Unbefugte Nutzung ist untersagt.",
      strategicTitle: "Strategische Vorteile",
      strategicItems: [
        { title: "Modular & Skalierbar", desc: "Passen Sie Ihr Sensornetzwerk einfach an jede Umgebung an — vom einzelnen Raum bis zum gesamten Gebäude." },
        { title: "Datenschutz-Architektur", desc: "Daten bleiben standardmäßig lokal. Wir verkaufen Ihre Daten nie und unser System ist von Grund auf datenschutzfreundlich." },
        { title: "Preisgekrönte Innovation", desc: "Ausgezeichnet mit dem BSFZ-Siegel 2025 für Forschung & Entwicklung — ein Zeichen zertifizierter Innovation." },
        { title: "Smart-Home-kompatibel", desc: "Matter-Unterstützung ermöglicht nahtlose Integration mit Alexa, Google Home und Apple HomeKit." },
        { title: "Budgetfreundliche Optionen", desc: "C3-Mini-Kits bieten Makern, Studierenden und DIY-Enthusiasten professionelle Sensortechnologie zu einem erschwinglichen Preis." },
        { title: "Bildungsimpact", desc: "Die Home Challenge Initiative ermöglicht Studierenden praktisches Lernen von IoT, Datenanalyse und Lösungsentwicklung." },
      ],
    },
    benefits: {
      badge: "Warum Carenuity",
      heroTitle: "Vorteile",
      heroDesc: "Entdecken Sie, wie Carenuity's modulare Sensorlösungen messbaren Mehrwert für Zuhause, Gesundheitseinrichtungen und Smart Buildings schaffen.",
      videoTitle: "Carenuity in Aktion erleben",
      videoDesc: "Sehen Sie, wie Carenuity-Sensorlösungen in realen Umgebungen funktionieren — von der Einrichtung bis zur Live-Überwachung.",
      ...
      useCases: [
        { title: "Privathaushalte", desc: "Überwachen Sie Luftqualität, Temperatur und Anwesenheit für Sicherheit und Komfort." },
        { title: "Gesundheitseinrichtungen", desc: "Verfolgen Sie Umgebungsparameter in Pflegeeinrichtungen zur Unterstützung des Wohlbefindens." },
        { title: "Smart Buildings", desc: "Skalierbare Sensornetzwerke für Büros, Schulen und Immobilien." },
        { title: "Bildungsprogramme", desc: "Studierende bauen und deployen eigene Sensorlösungen durch die Home Challenge Initiative." },
      ],
      ctaTitle: "Bereit loszulegen?",
      ctaDesc: "Installieren Sie Ihre erste Sensorlösung kostenlos und beginnen Sie mit der Überwachung.",
