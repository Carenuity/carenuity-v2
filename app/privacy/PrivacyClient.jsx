...
const P = ({ children }) => (
  <p className="mb-4 leading-relaxed text-body-color dark:text-gray-300">
    {children}
  </p>
);
const UL = ({ children }) => (
            ...
            {de ? (
              <>
                ...
                <P>
                  ...
                  GmbH, ein wichtiges Anliegen. Personenbezogene Daten sind alle
                  Informationen, mit denen Sie persönlich identifiziert werden
                  können. Diese Datenschutzerklärung erläutert, welche Daten wir
                ...
                <UL>
                  ...
                  <li>
                    Interaktionen mit Google-Diensten (Maps, YouTube, reCAPTCHA)
                  </li>
                </UL>
                ...
                <P>
                  ...
                  dies zur Erfüllung des jeweiligen Zwecks erforderlich ist oder
                  gesetzliche Aufbewahrungsfristen bestehen. Danach werden die
                  Daten gemäß Art. 17 DSGVO gelöscht oder anonymisiert.
                </P>
                ...
                <P>
                  ...
                  die Leistung zu verbessern. Nicht technisch notwendige Cookies
                  werden nur nach Ihrer Einwilligung gesetzt. Sie können Ihre
                  Zustimmung jederzeit über die Cookie-Einstellungen am
                  Seitenende ändern oder widerrufen.
                </P>
                ...
                <P>
                  ...
                  übermittelt. Nutzung erfolgt auf Grundlage berechtigter
                  Interessen zur Darstellung von Standorten.
                </P>
                ...
                <P>
                  ...
                  Ihre Daten vor Verlust, Manipulation und unbefugtem Zugriff zu
                  schützen.
                </P>
              ...
              <>
                ...
                <P>
                  We, the operators of this website, take the protection of your
                  personal data very seriously. Personal data refers to all
                  information that identifies you as an individual. This Privacy
                  Policy explains what data we collect, how we use it, and what
                  rights you have under the GDPR and German Federal Data
                  Protection Act (BDSG).
                </P>
                ...
                <UL>
                  ...
                  <li>
                    Interactions with Google services (Maps, YouTube, reCAPTCHA)
                  </li>
                </UL>
                ...
                <P>
                  ...
                  performance purposes. Non-essential cookies are only activated
                  after your consent, which you can withdraw or change anytime.
                </P>
                ...
                <H3>YouTube</H3>
                <P>
                  Embedded videos use YouTube iFrame. Data is handled by Google
                  under its privacy policy. Log out of your YouTube account to
                  prevent association.
                </P>
                <H3>Google Maps</H3>
                <P>
                ...
                <H3>Google reCAPTCHA</H3>
                <P>
                  Used to prevent spam. Sends IP and interaction data to Google
                  for verification.
                </P>
                <H3>Google Web Fonts</H3>
                <P>
                  Ensures consistent font display; your IP may be sent to Google
                  servers.
                </P>
                ...
                <H2>10. Updates</H2>
                <P>
                  This Privacy Policy is reviewed regularly. The latest version
                  is always available at www.chipglobe.com/privacy.
                </P>
              </>
            )}
          </div>
