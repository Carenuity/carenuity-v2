        ...
        <div className="container">
          <div className="grid grid-cols-12 gap-10 items-center">
            <div className="col-span-12 lg:col-span-7">
              ...
              <p className="text-body-color dark:text-green text-base leading-relaxed mb-5">
                {a.heroTitle}
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {a.overviewList.map((item) => (
                <div
                  key={item}
                  className="flex items-center gap-3 rounded-xl bg-white dark:bg-gray-950 px-4 py-3 shadow-two"
                >
                  <span
      ...
      <section className="bg-white dark:bg-gray-950 py-16">
        <div className="container">
          <h2 className="mb-3 text-3xl font-bold text-black dark:text-white md:text-4xl">
            {a.brandVisibilityTitle}
          </h2>
          <p className="text-body-color dark:text-green mb-10 text-base max-w-3xl">
            {a.brandVisibilityDesc}
          </p>
        ...
        <div className="container">
          <div className="grid grid-cols-12 gap-8 items-center">
            ...
            <div className="col-span-12 lg:col-span-4 flex justify-center lg:justify-end">
              <div
                className="w-20 h-20 rounded-2xl flex items-center justify-center shadow-two"
                style={{ backgroundColor: "#174f2e" }}
              >
                <svg
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {a.brands.map((brand) => (
              <div
                key={brand.name}
                className="flex items-start gap-4 rounded-2xl bg-green-bg dark:bg-gray-900 border border-gray-100 dark:border-gray-800 p-5 shadow-two"
              >
                <div
                ...
                >
                  ...
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m0 0l4.243-4.243a4 4 0 015.656 0l4 4a4 4 0 01-5.656 5.656l-1.102 1.101"
                    />
                  </svg>
                </div>
                <div>
                  ...
                  <p className="text-body-color dark:text-green text-xs leading-relaxed">
                    {brand.desc}
                  </p>
                </div>
              </div>
      ...
      <section className="bg-green-bg dark:bg-gray-900 py-16">
        <div className="container">
          <div className="grid grid-cols-12 gap-10 items-center">
            <div className="col-span-12 lg:col-span-7">
              <div
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-5 text-xs font-bold uppercase tracking-wider text-white"
                style={{ backgroundColor: "#174f2e" }}
              >
                Featured Product
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                {a.sqPanelFeatures.map((f) => (
                  <span
                    key={f}
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700 text-xs font-semibold text-black dark:text-white shadow-two"
                  >
                    <span
      ...
      <section className="bg-white dark:bg-gray-950 py-16">
        <div className="container">
          <div className="grid grid-cols-12 gap-10 items-start">
            <div className="col-span-12 lg:col-span-8">
              <h2 className="mb-5 text-3xl font-bold text-black dark:text-white md:text-4xl">
                {a.solutionBuilderTitle}
              </h2>
              <p className="text-body-color dark:text-green text-base leading-relaxed mb-8">
                {a.solutionBuilderDesc}
              </p>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {a.instagramChannels.map((ch) => (
              <div
                key={ch.handle}
                className="rounded-2xl border border-gray-100 dark:border-gray-800 bg-green-bg dark:bg-gray-900 p-6 shadow-two"
              >
