...
function SolutionWidget({ solutionId, title }) {
  const baseUrl = "https://solutions.carenuity.com/widgets/solutions/";
  return (
    <div
      className="relative w-full overflow-hidden rounded-lg dark:ring-2 dark:ring-gray-700"
      style={{ height: "19rem" }}
    >
      <iframe
...
export default function ThingSpeakApiKeyPage() {
  const { t } = useLanguage();
  const c = t.programsGuides.thingspeak;
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="flex-1 min-w-0">
              <div className="rounded-2xl bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-800 shadow-sm p-6 md:p-8">
                ...
                <ol className="list-decimal pl-6 space-y-2 text-body-color dark:text-green text-base leading-relaxed mb-8">
                  <li>{c.li1}</li>
                  <li>{c.li2}</li>
                  <li>
                    {c.li3}
                ...
                <img
                  src="/images/thinkspeak/thinkspeak.jpeg"
                  alt="ThingSpeak API keys"
                  className="w-full rounded-lg border border-gray-100 dark:border-gray-800 shadow-sm mb-8"
                />
                ...
                <SolutionWidget
                  solutionId="Wxzylq6d697T6mkUL74J"
                  title="ThingSpeak Applications"
                />
              </div>
