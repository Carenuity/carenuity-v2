...
const steps = [
  "/images/q-weather/register.png",
  "/images/q-weather/develop.png",
  "/images/q-weather/management.png",
  "/images/q-weather/project.png",
  "/images/q-weather/weather-key.png",
  "/images/q-weather/private-key.png",
];

export default function QWeatherApiKeyPage() {
  const { t } = useLanguage();
  const c = t.programsGuides.qweather;
            ...
            <div className="flex-1 min-w-0">
              <div className="rounded-2xl bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-800 shadow-sm p-6 md:p-8">
                ...
                <p className="text-body-color dark:text-green text-base leading-relaxed mb-8">
                  {c.registerPre}{" "}
                  <a
                    href="https://id.gweather.com/#/register"
                    target="_blank"
