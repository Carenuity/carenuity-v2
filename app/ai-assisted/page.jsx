      ...
      >
        ...
        <div className="container relative">
          <nav className="flex items-center gap-2 pt-6 pb-4 text-sm">
            ...
            <span className="font-medium text-white">AI Assisted Solutions</span>
          </nav>
          <div className="grid grid-cols-12 min-h-[440px] items-center">
            <div className="col-span-12 md:col-span-7 pb-16 pt-4">
              ...
              <p className="text-lg leading-relaxed text-white/80 md:text-xl">
                AI-assisted Carenuity devices combine cutting edge sensor technology with
                artificial intelligence to gather, process, and analyze data from their environment.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white dark:bg-gray-950 py-16">
        <div className="container">
          ...
          <p className="text-body-color dark:text-green mb-12 text-base max-w-3xl">
            These sensors detect various physical parameters including temperature, motion, and light,
            applying AI to make informed decisions based on gathered data.
          </p>
          ...
          <div className="col-span-12 mb-8">
            ...
            <p className="text-body-color dark:text-green text-base leading-relaxed mb-3 max-w-4xl">
              A radar sensor employs radio waves to detect stationary, approaching, departing or
              missing objects and measure their distance, speed, and other characteristics through
              area segmentation.
            </p>
            <p className="text-body-color dark:text-green text-base leading-relaxed max-w-4xl">
              Unlike conventional PIR sensors that rely on heat signatures and struggle with subtle
              motion or presence detection, the Carenuity™ SQ-Panel features a highly precise 60 GHz
              radar sensor. This advanced sensing technology enables real-time detection of
              micro-movements, even through materials, making it suitable for modern presence
              automation. Whether designing intelligent HVAC or lighting control or building a Home
              Assistant setup, the Carenuity™ SQ-Panel provides accurate occupancy data via MQTT
              and seamlessly integrates into smart ecosystems.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
            ...
            >
              <div className="relative h-[180px] w-full">
                <Image src="/images/ai-assisted/radar-sensor1.png" alt="HLK-LD2410C Radar Sensor" fill className="object-cover" />
              </div>
              <div className="p-5">
            ...
            >
              <div className="relative h-[180px] w-full">
                <Image src="/images/ai-assisted/radar-sensor2.png" alt="LD2410C Radar Sensor" fill className="object-cover" />
              </div>
              <div className="p-5">
                <h4 className="font-bold text-black dark:text-white text-sm mb-2">
            ...
            >
              <div className="relative h-[180px] w-full">
                <Image src="/images/ai-assisted/esp32-cam1.png" alt="BGT60LTR11 Radar Shield2Go" fill className="object-cover" />
              </div>
              <div className="p-5">
                <h4 className="font-bold text-black dark:text-white text-sm mb-2">
          ...
          {/* Canva iframe */}
          <div className="w-full mb-16" style={{ position: "relative", height: 0, paddingTop: "56.25%" }}>
            <iframe
          ...
          <div className="col-span-12 mt-6">
            ...
            <p className="text-body-color dark:text-green text-base leading-relaxed mb-3 max-w-4xl">
              The ESP32-CAM is a compact, low-cost module that combines an ESP32-S microcontroller
              with an OV2640 camera. In object detection applications, it proves particularly
              valuable due to built-in Wi-Fi and Bluetooth capabilities, enabling wireless image
              transmission and processing.
            </p>
            <p className="text-body-color dark:text-green text-base leading-relaxed mb-8 max-w-4xl">
              Leveraging libraries like OpenCV and machine learning models, the ESP32-CAM performs
              real-time object detection and identification. This makes it ideal for home
              automation, security systems, and IoT projects requiring visual data capture and
              analysis.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              ...
              >
                <div className="relative h-[180px] w-full">
                  <Image src="/images/ai-assisted/esp32-cam2.png" alt="ESP32-CAM Smart Object Detector" fill className="object-cover" />
                </div>
                <div className="p-5">
                  <h4 className="font-bold text-black dark:text-white text-sm mb-2">
          ...
          <div className="grid grid-cols-12 gap-10 items-center">
            <div className="col-span-12 lg:col-span-8">
              ...
              <p className="text-body-color dark:text-green text-base leading-relaxed mb-4">
                In the world of automotive innovation, history often serves as a foundation for
                future advancements. The Autonomous Driving Infineon Car, built by ChipGlobe&rsquo;s
                Carenuity team, is a testament to this principle.
              </p>
              <p className="text-body-color dark:text-green text-base leading-relaxed mb-4">
                This vehicle embodies the latest autonomous driving technology while honoring the
                legendary Schaeffler FAG Model MF3, unveiled in June 2009. The shark-like design of
                the MF3, symbolizing speed and precision, has been reincarnated in 2025 in a 1:10
                ratio model, showcasing the blend of past and present engineering achievements.
              </p>
              <p className="text-body-color dark:text-green text-base leading-relaxed mb-6">
                The Schaeffler FAG Model MF3 unveiling occurred at an evening event at Schaeffler&rsquo;s
                foyer, attended by Dr. Grunau, former representative of the FAG Schaeffler Group
                Industry management board, and Dipl.-Ing. Seubert, former chairman of the
                Unterfranken district association of the Verein Deutscher Ingenieure (VDI).
              </p>
              <Link
