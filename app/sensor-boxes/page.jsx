        ...
        <div className="container">
          ...
          <div className="grid grid-cols-12 gap-6">
            {c.healthcareCards.map((card, i) => (
              <div
                key={i}
                className="col-span-12 md:col-span-6 rounded-2xl bg-white dark:bg-gray-950 shadow-two overflow-hidden hover:shadow-one hover:-translate-y-1 transition-all duration-300"
              >
                <div className="relative h-[220px] w-full overflow-hidden">
                  <Image
                    src={
                      [
                        "/images/selection-boxes/c3-mini-selection-box-case.png",
                        "/images/selection-boxes/bio-pulse-meter.jpeg",
                      ][i]
                    }
                    alt={card.title}
                    fill
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-12 gap-6">
            {c.motionCards.map((card, i) => (
              <div
                key={i}
                className="col-span-12 md:col-span-6 rounded-2xl bg-white dark:bg-gray-950 shadow-two overflow-hidden hover:shadow-one hover:-translate-y-1 transition-all duration-300 border border-gray-100 dark:border-gray-800"
              >
                <div className="relative h-[220px] w-full overflow-hidden">
                  <Image
